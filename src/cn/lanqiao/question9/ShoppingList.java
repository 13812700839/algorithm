...
/**
 * <p>购物单</p>
 * <p>题目描述：小明刚刚找到工作，老板人很好，只是老板夫人很爱购物。老板忙的时候经常让小明帮忙到商场代为购物。小明很厌烦，但又不好推辞。</p>
 *          <p>这不，大促销又来了！老板夫人开出了长长的购物单（详见 data.txt），都是有打折优惠的。</p>
 *          <p>小明也有个怪癖，不到万不得已，从不刷卡，直接现金搞定。</p>
 *          <p>现在小明很心烦，请你帮他计算一下，需要从取款机上取多少现金，才能搞定这次购物。</p>
 *          <p>取款机只能提供 100 元面额的纸币。小明想尽可能少取些现金，够用就行了。 你的任务是计算出，小明最少需要取多少现金。</p>
 * <p>难度：简单</p>
 * <p>标签：填空题, 2017, 省赛</p>
 * <p>时空限制：1s/128M</p>
 * <p><a href="https://www.lanqiao.cn/problems/645/learning/">题目链接地址</a></p>
 *
 * @author Pengcc
